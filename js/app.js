...
function genarateobject() {
  ...
  new Animated('image/violin.8.png','Cremona 180E Premier ', '127');
  ...
  new Animated('image/piano8.png','Yamaha D17 piano', '1621');
  ...
  new Animated('image/gu8.png','Lyons Classroom Guitar', '87');
  ...
  new Animated('image/drum8.png','CP CP221 Tunable', '110');
}
